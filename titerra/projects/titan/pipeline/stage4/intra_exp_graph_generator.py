...
# Project packages
from titan.pipeline.stage4.flexibility_plots import FlexibilityPlotsCSVGenerator
...
class IntraExpGraphGenerator(stage4.intra_exp_graph_generator.IntraExpGraphGenerator):
    ...
    def __call__(self, criteria: bc.IConcreteBatchCriteria) -> None:
        ...
        :class:`~sierra.core.pipeline.stage4.intra_exp_graph_generator.IntraExpGraphGenerator`, run
        the following to generate graphs within each experiment in the batch:
