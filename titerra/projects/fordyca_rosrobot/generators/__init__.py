...
# Do the lifts
sys.modules['fordyca_rosrobot.generators.scenario_generator_parser'] = scenario_generator_parser
sys.modules['fordyca_rosrobot.generators.exp_generators'] = rosrobot
