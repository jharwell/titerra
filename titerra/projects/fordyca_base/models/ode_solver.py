...
# Project packages
from titerra.projects.fordyca_base.models.interference import IntraExp_RobotInterferenceRate_NRobots
...
class CRWSolver():
    ...
    @staticmethod
    def kernel(z, t, self, params: tp.Dict[str, float]):
        N = params['N']
        N_s = z[0]
        N_h = z[1]
        N_avs = z[2]
