...
# Common TITAN packages to lift into 'fordyca_ros1gazebo.pipeline.stage3' namespace for use in
# the SIERRA project for FORDYCA.
from titerra.projects.common.pipeline.stage3 import run_collator

# Do the lifts
sys.modules['fordyca_ros1gazebo.pipeline.stage3.run_collator'] = run_collator
