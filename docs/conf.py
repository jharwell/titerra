...
# -*- coding: utf-8 -*-
#
# Titerra documentation build configuration file, created by
...
xref_links = {
    ...
    "SIERRA": ("SIERRA", "https://swarm-robotics-fordyca.readthedocs.io"),
...
latex_documents = [
    (master_doc, 'Titerra.tex', 'Titerra Documentation',
     'John Harwell', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'Titerra', 'Titerra Documentation',
     author, 'Titerra', 'One line description of project.',
     'Miscellaneous'),
]
...
intersphinx_mapping = {'python3': ('https://docs.python.org/3', None),
                       ...
                       'sierra': ('https://swarm-robotics-sierra.readthedocs.io/en/latest', None)
                       }
